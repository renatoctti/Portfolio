...
const KW_EN = {
  p1: [
    ...
    { text: "SQL databases",       type: "tech"   },
    { text: "AI-powered solutions",type: "tech"   },
  ],
  p2: [
    { text: "Vennx",                              type: "proper" },
    { text: "RAG pipelines",                      type: "tech"   },
    { text: "meeting intelligence platforms",     type: "tech"   },
    { text: "BPMN generation",                    type: "tech"   },
    { text: "LLMs",                               type: "tech"   },
    { text: "Italian-Brazilian Chamber of Commerce", type: "proper" },
  ],
  p3: [
    { text: "software engineering", type: "tech"   },
    { text: "automation",           type: "tech"   },
    { text: "AI",                   type: "tech"   },
    { text: "scalable systems",     type: "tech"   },
  ],
...
const KW_PT = {
  ...
  p2: [
    ...
    { text: "BPMN",                               type: "tech"   },
    { text: "LLMs",                               type: "tech"   },
    { text: "Câmara Ítalo-Brasileira de Comércio",type: "proper" },
  ],
  p3: [
    { text: "automação",            type: "tech"   },
    { text: "IA",                   type: "tech"   },
    { text: "sistemas escaláveis",  type: "tech"   },
  ],
} satisfies Record<string, Keyword[]>;
